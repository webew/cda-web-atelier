...
class InterventionController extends AbstractController
{
    ...
    #[Route('/newByTicket/{id}', name: 'app_intervention_new_by_ticket', methods: ['GET', 'POST'])]
    public function newByTicket(Ticket $ticket, Request $request, InterventionRepository $interventionRepository): Response
    {
        $intervention = new Intervention();
